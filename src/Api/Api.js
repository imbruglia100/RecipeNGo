...
const recipeApi = {
  ...
  getByIngredients: async (ingredientList) => {
    ...
    return await fetch(
      `https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?ingredients=${querySearchIngredients}&number=5&limitLicense=true&ranking=1`,
      options
    )
      .then((response) => response.json())
